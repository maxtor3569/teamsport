  ...
  $(function() {
	...
	var contentBox ="<form action='{{ path('ImageProfile') }}' method='post' enctype='multipart/form-data'>Ch?n h�nh ?nh :<input id='imageProfile' name='file' type='file'/><input type='submit'></form>";
	...
	function notification_play(id)
	{
        ...
        success: function(data){
			...
			Alertify.dialog.alert('Thu m?i choi c�ng d� du?c g?i t?i ngu?i choi. C�m on.');
			window.parent.Shadowbox.close();
