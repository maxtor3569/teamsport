...
/* SportimimiuserBundle:Page:registrationComplete.html.twig */
class __TwigTemplate_2cf4975c0495de30b95f55a0ffc734f92a568bef971c2a7be98f8c64e6d643a1 extends Twig_Template
{
    ...
    {
        // line 7
        echo "<div style=\"padding:25px;font-size:14pt;border:1px solid #ccc;background:white;margin-top:15px\">
    <header>
...
\t\t<br />
\t\t<strong>Vui lòng mở mail và làm theo hướng dẫn để kích hoạt tài khoản của bạn.</strong>
\t\t<br />
\t\t>>Nếu không nhận được E-mail kích hoạt, bạn vui lòng kiểm tra Hộp thư Bulk / Spam
\t\t<br />
\t\t>>Nếu bạn không nhận được E-mail, vui lòng đợi khoảng 15 phút và kiểm tra lại.
\t\t<br />
\t\t>>Nếu có bất kỳ vấn đề nào hãy liên hệ với chúng tôi
\t</p>
</div>\t
";
    }
    ...
    {
        return "SportimimiuserBundle:Page:registrationComplete.html.twig";
    }
