...
$catalogue = new MessageCatalogue('en', array (
  ...
  array (
    'Trang Chủ' => 'Home',
    'Đăng nhập' => 'Login',
    '- Chọn thể thao -' => '- Filter by sport -',
    'Berlin' => 'Berlin',
    'Chọn Giới Tính' => 'Filter by gender',
    'Chọn Quốc' => 'Filter by nationality',
    'Giới tính' => 'Giới tính',
    'Họ' => 'Family name',
    'London' => 'London',
    'Mật khẩu' => 'Password',
    ...
    'Quốc' => 'Nationality',
    'Sân' => 'Sân',
    'Sélectionnez un sexe' => 'Sélectionnez un sexe',
    ...
    'Video' => 'Video',
    'Điện thoại' => 'Phone',
    'Tìm Người Chơi' => 'Search Sport Partner',
    'Tìm Đội' => 'Search Team',
    'Hồ Sơ Của Tôi' => 'My Profile',
    'Về chúng tôi' => 'About us',
    'Liên hệ' => 'Contact us',
    'Chào mừng bạn' => 'Welcome To',
    'đến với TeamSport.vn' => 'TeamSport.vn',
    'Tham gia' => 'Join now !',
    'Tài khoản vừa tạo' => 'Recent Account',
    'Team vừa tạo' => 'Recent Team',
    'Theo hiệu suất của bạn' => 'Improve your performance by following your sport results',
    'Tổ chức phù hợp với bạn bè của bạn' => 'Find the best partner to do sport',
    'Tìm câu lạc bộ hoặc nhóm' => 'Find or create your sport team',
    'Đăng ký tài khoản' => 'Register Account',
    'Đăng ký' => 'Register',
    'Thành viên đăng nhập' => 'Login Account',
    'Nhớ tôi' => 'Remember Me',
    'Nhập email của bạn' => 'Enter your email',
    'Nhập mật khẩu của bạn' => 'Enter your password',
    'Mô tả bản thân' => 'Describe yourself to meet other athletes.',
    'Bạn' => 'Friend',
    'Ngày Sinh' => 'Birthday',
    'Thể thao' => 'Sport',
    ...
    'tuổi' => 'Friend',
    'Thoát' => 'Log out',
    'Tìm Sự Kiện' => 'Find Events',
    'Thành Viên' => 'Members',
    'Ngôn ngư' => 'Language',
    'Tin nhắn' => 'Messages',
    'Quản lý đội của tôi' => 'Manage My Teams',
    'Tìm Sân Chơi' => 'Find Sports Fields',
  ...
  array (
    ...
    'AcceptProfileTeam' => '/acceptProfileTeam/{id}',
    'AddEvent' => '/them-tao-su-kien',
    'AddProfile' => '/dang-ky-ho-so',
    'AddProfileToTeam' => '/addProfileTeam',
    'CategoryList' => '/category/{id}',
    'ChallengeTeam' => '/challengeTeam',
    'ChangeNameTeam' => '/changeName',
    'ChangePosition' => '/changePosition',
    'Contact' => '/lien-he',
    'CreateTeam' => '/createTeam',
    'DeleteProfile' => '/listProfile/delete/{id}',
    'DeleteTeam' => '/deleteTeam',
    'DetailEvent' => '/su-kien/{id}',
    'DetailMatch' => '/tran-dau/{id}',
    'DetailProfile' => '/ho-so-cua-toi',
    'Feedback' => '/feedback',
    'ImageProfile' => '/imageProfile',
    'InviteFriend' => '/addFriend',
    'InviteMeToTeam' => '/inviteMe',
    'ListEvent' => '/tim-su-kien',
    'ListProfile' => '/tim-nguoi-choi',
    'ListTeam' => '/tim-doi',
    'NotificationViewed' => '/notificationsViewed',
    'PhotoProfile' => '/photoProfile',
    'RechercheProfile' => '/searchProfile',
    'RegistrationComplete' => '/dang-ky-thanh-cong',
    'RemoveFriend' => '/removeFriend/{id}',
    'RemoveProfileToTeam' => '/removeProfileTeam',
    'SetWinnerMatch' => '/set-winner/{id}',
    'SkillsSheet' => '/bang-ky-nang',
    'SwitchLanguage' => '/switchLanguage',
    'UpdateProfile' => '/cap-nhat-ho-so',
    'ViewTeam' => '/detailTeam/{name}',
    'console' => '/console/',
    'console_exec' => '/console.{_format}',
    'fos_user_change_password' => '/profile/change-password',
    'fos_user_group_delete' => '/group/{groupname}/delete',
    'fos_user_group_edit' => '/group/{groupname}/edit',
    'fos_user_group_list' => '/group/list',
    'fos_user_group_new' => '/group/new',
    'fos_user_group_show' => '/group/{groupname}',
    'fos_user_profile_edit' => '/profile/edit',
    'fos_user_profile_show' => '/profile/',
    'fos_user_registration_check_email' => '/inscription/check-email',
    'fos_user_registration_confirm' => '/inscription/confirm/{token}',
    'fos_user_registration_confirmed' => '/inscription/confirmed',
    'fos_user_registration_register' => '/inscription/',
    ...
    'fos_user_security_login' => '/dang-nhap',
    'fos_user_security_logout' => '/logout',
    'sonata_admin_append_form_element' => '/admin/core/append-form-field-element',
    'sonata_admin_dashboard' => '/admin/dashboard',
    'sonata_admin_retrieve_form_element' => '/admin/core/get-form-field-element',
    'sonata_admin_set_object_field_value' => '/admin/core/set-object-field-value',
    'sonata_admin_short_object_information' => '/admin/core/get-short-object-description',
    '﻿Homepage' => '/',
  ),
  'FOSUserBundle' => 
  array (
...
$catalogueVi = new MessageCatalogue('vi', array (
  ...
  array (
    ...
    'The fields {{ fields }} were not expected.' => 'Trường có tên {{ fields }} không được chấp nhận.',
    'The fields {{ fields }} are missing.' => 'Trường có tên {{ fields }} không tìm thấy.',
    ...
    'This value should be the user current password.' => 'Giá trị này phải là mật khẩu hiện tại của người dùng.',
