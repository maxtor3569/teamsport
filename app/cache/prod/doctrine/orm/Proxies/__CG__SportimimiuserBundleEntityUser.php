 ...
 */
class User extends \Sportimimi\userBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Sportimimi\\userBundle\\Entity\\User' . "\0" . 'profile', 'groups', '' . "\0" . 'Sportimimi\\userBundle\\Entity\\User' . "\0" . 'lastActive', '' . "\0" . 'Sportimimi\\userBundle\\Entity\\User' . "\0" . 'newsletter', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function setLastActive($dateActive)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLastActive', array($dateActive));

        return parent::setLastActive($dateActive);
    }
