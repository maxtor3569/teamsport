 ...
 */
class Skills extends \Sportimimi\userBundle\Entity\Skills implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Sportimimi\\userBundle\\Entity\\Skills' . "\0" . 'profile', 'agility', 'speed', 'stamina', 'strength');
        }
    ...
    public function getStamina()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getStamina', array());

        return parent::getStamina();
    }
    ...
    public function setStamina($stamina)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setStamina', array($stamina));

        return parent::setStamina($stamina);
    }
