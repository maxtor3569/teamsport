 ...
 */
class Article extends \Sportimimi\userBundle\Entity\Article implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Sportimimi\\userBundle\\Entity\\Article' . "\0" . 'name', '' . "\0" . 'Sportimimi\\userBundle\\Entity\\Article' . "\0" . 'dateCreated', '' . "\0" . 'Sportimimi\\userBundle\\Entity\\Article' . "\0" . 'content', 'author');
        }
    ...
    public function getAuthor(\Sportimimi\userBundle\Entity\Profile $author)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAuthor', array($author));

        return parent::getAuthor($author);
    }
