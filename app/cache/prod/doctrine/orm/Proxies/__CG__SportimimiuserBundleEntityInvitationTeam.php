 ...
 */
class InvitationTeam extends \Sportimimi\userBundle\Entity\InvitationTeam implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Sportimimi\\userBundle\\Entity\\InvitationTeam' . "\0" . 'profile', '' . "\0" . 'Sportimimi\\userBundle\\Entity\\InvitationTeam' . "\0" . 'team', 'status');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (InvitationTeam $proxy) {
