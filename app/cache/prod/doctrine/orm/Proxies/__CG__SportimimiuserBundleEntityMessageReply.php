 ...
 */
class MessageReply extends \Sportimimi\userBundle\Entity\MessageReply implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Sportimimi\\userBundle\\Entity\\MessageReply' . "\0" . 'message', '' . "\0" . 'Sportimimi\\userBundle\\Entity\\MessageReply' . "\0" . 'profile', 'content', '' . "\0" . 'Sportimimi\\userBundle\\Entity\\MessageReply' . "\0" . 'created');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MessageReply $proxy) {
