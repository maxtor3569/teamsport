 ...
 */
class Match extends \Sportimimi\userBundle\Entity\Match implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Sportimimi\\userBundle\\Entity\\Match' . "\0" . 'teams', 'winner', 'score');
        }
    ...
    public function getWinner()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getWinner', array());
    ...
    public function setWinner(\Sportimimi\userBundle\Entity\Team $team)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setWinner', array($team));

        return parent::setWinner($team);
    }
