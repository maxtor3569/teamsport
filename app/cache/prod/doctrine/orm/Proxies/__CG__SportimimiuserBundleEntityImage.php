 ...
 */
class Image extends \Sportimimi\userBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Sportimimi\\userBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'Sportimimi\\userBundle\\Entity\\Image' . "\0" . 'url', '' . "\0" . 'Sportimimi\\userBundle\\Entity\\Image' . "\0" . 'type', '' . "\0" . 'Sportimimi\\userBundle\\Entity\\Image' . "\0" . 'profile', '' . "\0" . 'Sportimimi\\userBundle\\Entity\\Image' . "\0" . 'team', '' . "\0" . 'Sportimimi\\userBundle\\Entity\\Image' . "\0" . 'event', '' . "\0" . 'Sportimimi\\userBundle\\Entity\\Image' . "\0" . 'alt', 'file', '' . "\0" . 'Sportimimi\\userBundle\\Entity\\Image' . "\0" . 'tempFilename');
        }
