 ...
 */
class PlaceCurrentlyPlay extends \Sportimimi\userBundle\Entity\PlaceCurrentlyPlay implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'createdAt', 'finishAt', 'profile', 'place');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PlaceCurrentlyPlay $proxy) {
    ...
    public function setFinishAt($finish)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFinishAt', array($finish));

        return parent::setFinishAt($finish);
    }
