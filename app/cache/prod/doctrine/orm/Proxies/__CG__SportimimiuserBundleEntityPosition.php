 ...
 */
class Position extends \Sportimimi\userBundle\Entity\Position implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'profile', 'team', 'topPos', 'leftPos');
        }
    ...
    public function setTopPos($pos)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTopPos', array($pos));

        return parent::setTopPos($pos);
    }
