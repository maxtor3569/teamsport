 ...
 */
class Comment extends \Sportimimi\userBundle\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Sportimimi\\userBundle\\Entity\\Comment' . "\0" . 'content', '' . "\0" . 'Sportimimi\\userBundle\\Entity\\Comment' . "\0" . 'created', 'profile', 'news');
        }
