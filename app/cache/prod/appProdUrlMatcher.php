...
class appProdUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // vi__RG__OAuth
        if ($pathinfo === '/connect') {
            return array (  '_controller' => 'Sportimimi\\userBundle\\Controller\\ApiController::indexAction',  '_locale' => 'vi',  '_route' => 'vi__RG__OAuth',);
        }

        // en__RG__OAuth
        if ($pathinfo === '/en/connect') {
            return array (  '_controller' => 'Sportimimi\\userBundle\\Controller\\ApiController::indexAction',  '_locale' => 'en',  '_route' => 'en__RG__OAuth',);
        }
